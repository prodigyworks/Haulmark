<?php
	...
	class DeliveryNoteReport2 extends PDFReport {
		var $y = 35;
		var $member;
		...
		function __construct($orientation, $metric, $size, $ids) {
			...
			if ($result) {
				...
				while (($member = mysql_fetch_assoc($result))) {
					...
					if ($member['startvisittype'] != "") {
						$this->newPage();
						
						if ($member['startvisittype'] == "B" || $member['startvisittype'] == "D") {
		 					$this->addText(15, $y, "Delivery", 10, 4.5, 'B', 80);
		 					$y = $this->addText(60, $y, $member['fromplace'], 10, 4.5, '', 180);
							$this->addText(15, $y, "Date", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['startdate'], 10, 4.5, '', 80);
							$this->addText(15, $y, "Time", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['starttime'], 10, 4.5, '', 80);
							$this->addText(15, $y, "Reference", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['fromplace_ref'], 10, 4.5, '', 80);
							$this->addText(15, $y, "Phone", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['fromplace_phone'], 10, 4.5, '', 80) + 2;
						}
							
						if ($member['startvisittype'] == "B" || $member['startvisittype'] == "C") {
					...
					if ($itemresult) {
						while (($itemmember = mysql_fetch_assoc($itemresult))) {
							if ($itemmember['visittype'] != "") {
								$this->newPage();
								
								if ($itemmember['visittype'] == "B" || $itemmember['visittype'] == "D") {
				 					$this->addText(15, $y, "Delivery", 10, 4.5, 'B', 80);
									...
									$this->addText(15, $y, "Phone", 10, 4.5, 'B', 80);
									$y = $this->addText(60, $y, $itemmember['phone'], 10, 4.5, '', 80) + 2;
								}
									
								if ($itemmember['visittype'] == "B" || $itemmember['visittype'] == "C") {
									$this->addText(15, $y, "Collection", 10, 4.5, 'B', 80);
				 					$y = $this->addText(60, $y, $itemmember['place'], 10, 4.5, '', 180);
									$this->addText(15, $y, "Date", 10, 4.5, 'B', 80);
									$y = $this->addText(60, $y, $itemmember['startdate'], 10, 4.5, '', 80);
					...
					if ($member['endvisittype'] != "") {
						$this->newPage();
						
						if ($member['endvisittype'] == "B" || $member['endvisittype'] == "D") {
		 					$this->addText(15, $y, "Delivery", 10, 4.5, 'B', 80);
		 					$y = $this->addText(60, $y, $member['toplace'], 10, 4.5, '', 180);
							$this->addText(15, $y, "Date", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['enddate'], 10, 4.5, '', 80);
							$this->addText(15, $y, "Time", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['endtime'], 10, 4.5, '', 80);
							$this->addText(15, $y, "Reference", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['toplace_ref'], 10, 4.5, '', 80);
							$this->addText(15, $y, "Phone", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['toplace_phone'], 10, 4.5, '', 80) + 2;
		 											}
							
						if ($member['endvisittype'] == "B" || $member['endvisittype'] == "C") {
							$this->addText(15, $y, "Collection", 10, 4.5, 'B', 80);
		 					$y = $this->addText(60, $y, $member['toplace'], 10, 4.5, '', 180);
							$this->addText(15, $y, "Date", 10, 4.5, 'B', 80);
							$y = $this->addText(60, $y, $member['enddate'], 10, 4.5, '', 80);
